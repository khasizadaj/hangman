...
#     get_mapped_letters,
#     update_masked_word,
#     get_pretty_masked_word,
#     is_provided,
#     check_input,
#     get_pretty_used_letters,
#     get_guess,
#     show_used_letters,
#     get_word_details,
#     word_is_found,
...
#         script = is_provided("a", ["a", "b"])
#         self.assertTrue(script)

#         script = is_provided("a", ["b", "c"])
#         self.assertFalse(script)

#         script = is_provided("ab", ["b", "c"])
#         self.assertFalse(script)

#         script = is_provided("", ["b", "c"])
#         self.assertFalse(script)

#         script = is_provided(None, ["b", "c"])
#         self.assertFalse(script)

#         script = is_provided(1, ["b", "c"])
#         self.assertFalse(script)
...
#         script: bool = guess_word(word="anger")
#         self.assertFalse(script)

#         input.side_effect = ["e", "a", "g", "r"]
#         script: bool = guess_word(word="eager")
#         self.assertTrue(script)

#         input.side_effect = ["a"]
#         script: bool = guess_word(word="a")
#         self.assertTrue(script)
